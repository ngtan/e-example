...
export class CategoryRepository {
  ...
  async findById(id: string): Promise<Category | null> {
    ...
    try {
      ...
      console.log('CategoryRepository.findById', error);
    }
  }
  ...
  async findBySlug(slug: string): Promise<Category | null> {
    ...
    try {
      const response = await this.httpClient.get(`categories/${slug}`);
      return response.data;
    } catch (error) {
      console.log('CategoryRepository.findBySlug', error);
    }
  }
  ...
  async findAll(): Promise<Category[]> {
    try {
      ...
      console.log('CategoryRepository.findAll', error);
    }
  }
